...
```{r }
options(scipen=999)
BC_data = read.csv("species_master_processed.csv")
lm1 = lmer(BC_Dissimilarity ~  Orthopedic_Injury_1+Orthopedic_Injury_2+Prescription_Medications_1+ Prescription_Medications_2+ Prescription_Medications_3+ Caffeine_1 + Caffeine_2 + Caffeine_3 + Caffeine_4 + Cannabis_1 + Cannabis_2 + Cannabis_3 + Cannabis_4 + Self_Reported_Illness_1 + Self_Reported_Illness_2+ Self_Reported_Illness_3+Impact_Load_ROUGH + Blood_In_Stool + Bristol_Stool_Scale_1 +Bristol_Stool_Scale_2 + Bristol_Stool_Scale_3 +Bristol_Stool_Scale_4 +Bristol_Stool_Scale_6 +Bristol_Stool_Scale_7 + Suspected_Head_Impact_off_the_Field +Suspected_Head_Impact_on_the_Field + Nicotine_Products_1+Nicotine_Products_2+Nicotine_Products_3+Nicotine_Products_4 +  Creatine_1+Creatine_2 +Change_of_Living_or_Dining_Circumstance_1+Change_of_Living_or_Dining_Circumstance_3 + (1|Player), data = BC_data)
summary(lm1)

time_data = read.csv("time_data.csv")
BC_data$Days = time_data$Days
BC_data$Player = as.factor(BC_data$Player)

lm2 = lmer(BC_Dissimilarity ~  Impact_Load_ROUGH*Days +Orthopedic_Injury_1+Orthopedic_Injury_2+Prescription_Medications_1+ Prescription_Medications_2+ Prescription_Medications_3+ Caffeine_1 + Caffeine_2 + Caffeine_3 + Caffeine_4 + Cannabis_1 + Cannabis_2 + Cannabis_3 + Cannabis_4 + Self_Reported_Illness_1 + Self_Reported_Illness_2+ Self_Reported_Illness_3 + Blood_In_Stool + Bristol_Stool_Scale_1 +Bristol_Stool_Scale_2 + Bristol_Stool_Scale_3 +Bristol_Stool_Scale_4 +Bristol_Stool_Scale_6 +Bristol_Stool_Scale_7 + Suspected_Head_Impact_off_the_Field +Suspected_Head_Impact_on_the_Field + Nicotine_Products_1+Nicotine_Products_2+Nicotine_Products_3+Nicotine_Products_4 +  Creatine_1+Creatine_2 +Change_of_Living_or_Dining_Circumstance_1+Change_of_Living_or_Dining_Circumstance_3 + (1|Player), data = subset(BC_data, Player != "9"))
sink("LM_Beta_R.txt")
print(summary(lm2))
sink()

#bestglmer(lm2)
#summary(glmmLasso(BC_Dissimilarity ~  Impact_Load_ROUGH+Days+Impact_Load_ROUGH:Days+ +Orthopedic_Injury_1+Orthopedic_Injury_2+Prescription_Medications_1+ Prescription_Medications_2+ Prescription_Medications_3+ Caffeine_1 + Caffeine_2 + Caffeine_3 + Caffeine_4 + Cannabis_1 + Cannabis_2 + Cannabis_3 + Cannabis_4 + Self_Reported_Illness_1 + Self_Reported_Illness_2+ Self_Reported_Illness_3 + Blood_In_Stool + Bristol_Stool_Scale_1 +Bristol_Stool_Scale_2 + Bristol_Stool_Scale_3 +Bristol_Stool_Scale_4 +Bristol_Stool_Scale_6 +Bristol_Stool_Scale_7 + Nicotine_Products_1+Nicotine_Products_2+Nicotine_Products_3+Nicotine_Products_4 +  Creatine_1+Creatine_2 +Change_of_Living_or_Dining_Circumstance_1+Change_of_Living_or_Dining_Circumstance_3 ,rnd = list(Player=~1), data = subset(BC_data, Player!="9"), lambda = 0))


lm3 = lmer(BC_Dissimilarity ~  Impact_Load_ROUGH*Days +(1|Player),data = subset(BC_data, Player != "9"))
print(summary(lm3))



tempModel = BC_data[, c("BC_Dissimilarity", "Impact_Load_ROUGH", "Player", "Days")]
tempModel = subset(tempModel, Player!="9" )
tempModel$Player = as.factor(tempModel$Player)
tempModel$fit = predict(lm3)

png(filename = "BC_Mixed_Model.png", width = 8, height = 5, units = "in", res =300)
ggplot(data = tempModel, aes(x = Impact_Load_ROUGH, y = BC_Dissimilarity,col = Player, group = interaction(Impact_Load_ROUGH, Days)) )+
  geom_line(aes(y=fit, group=Player), size=0.8) +
  geom_point(alpha = 0.8) + 
  theme_bw() + xlab("Impact Load") + ylab("Bray-Curtis Dissimilarity")
dev.off()
```

```{r }

order_data = read.csv("order_master_processed.csv")
lm_Bact = lmer(Bacteroidales ~  Orthopedic_Injury_1+Orthopedic_Injury_2+Prescription_Medications_1+ Prescription_Medications_2+ Prescription_Medications_3+ Caffeine_1 + Caffeine_2 + Caffeine_3 + Caffeine_4 + Cannabis_1 + Cannabis_2 + Cannabis_3 + Cannabis_4 + Self_Reported_Illness_1 + Self_Reported_Illness_2+ Self_Reported_Illness_3+Impact_Load_ROUGH + Blood_In_Stool + Bristol_Stool_Scale_1 +Bristol_Stool_Scale_2 + Bristol_Stool_Scale_3 +Bristol_Stool_Scale_4 +Bristol_Stool_Scale_6 +Bristol_Stool_Scale_7 + Suspected_Head_Impact_off_the_Field +Suspected_Head_Impact_on_the_Field + Nicotine_Products_1+Nicotine_Products_2+Nicotine_Products_3+Nicotine_Products_4 +  Creatine_1+Creatine_2 +Change_of_Living_or_Dining_Circumstance_1+Change_of_Living_or_Dining_Circumstance_3 + (1|Player), data = subset(order_data, Player!="9" ))
sink("LM_Bact_R.txt")
print(summary(lm_Bact))
sink()


tempModel = order_data[, c("Bacteroidales", "Impact_Load_ROUGH", "Player")]
tempModel = subset(tempModel, Player!="9" )
tempModel$Player = as.factor(tempModel$Player)
tempModel$fit = predict(lmer(Bacteroidales ~  Impact_Load_ROUGH + (1|Player), data = subset(order_data, Player!="9" )))
png(filename = "Bact_Mixed_Model.png", width = 8, height = 5, units = "in", res =300)
ggplot(data = tempModel, aes(x = Impact_Load_ROUGH, y = Bacteroidales,col = Player, group = Player))+
  geom_line(aes(y=fit, group=Player), size=0.8) +
  geom_point(alpha = 0.8) + 
  theme_bw() + xlab("Impact Load") + ylab("% change in Bacteroidales")
dev.off()
lm_Bifi = lmer(Bifidobacteriales ~  Orthopedic_Injury_1+Orthopedic_Injury_2+Prescription_Medications_1+ Prescription_Medications_2+ Prescription_Medications_3+ Caffeine_1 + Caffeine_2 + Caffeine_3 + Caffeine_4 + Cannabis_1 + Cannabis_2 + Cannabis_3 + Cannabis_4 + Self_Reported_Illness_1 + Self_Reported_Illness_2+ Self_Reported_Illness_3+Impact_Load_ROUGH + Blood_In_Stool + Bristol_Stool_Scale_1 +Bristol_Stool_Scale_2 + Bristol_Stool_Scale_3 +Bristol_Stool_Scale_4 +Bristol_Stool_Scale_6 +Bristol_Stool_Scale_7 + Suspected_Head_Impact_off_the_Field +Suspected_Head_Impact_on_the_Field + Nicotine_Products_1+Nicotine_Products_2+Nicotine_Products_3+Nicotine_Products_4 +  Creatine_1+Creatine_2 +Change_of_Living_or_Dining_Circumstance_1+Change_of_Living_or_Dining_Circumstance_3 + (1|Player), data = subset(order_data, Player!="9"))
sink("LM_Bifi_R.txt")
print(summary(lm_Bifi))
sink()

tempModel = order_data[, c("Bifidobacteriales", "Impact_Load_ROUGH", "Player")]
tempModel = subset(tempModel, Player!="9" )
tempModel$Player = as.factor(tempModel$Player)
tempModel$fit = predict(lmer(Bifidobacteriales ~  Impact_Load_ROUGH + (1|Player), data = subset(order_data, Player!="9" )))
png(filename = "Bifi_Mixed_Model.png", width = 8, height = 5, units = "in", res =300)
ggplot(data = tempModel, aes(x = Impact_Load_ROUGH, y = Bifidobacteriales,col = Player, group = Player))+
  geom_line(aes(y=fit, group=Player), size=0.8) +
  geom_point(alpha = 0.8) + 
  theme_bw() + xlab("Impact Load") + ylab("% change in Bifidobacteriales")
dev.off()


tempModel = order_data[, c("Lachnospirales", "Impact_Load_ROUGH", "Player")]
tempModel = subset(tempModel, Player!="9" )
tempModel$Player = as.factor(tempModel$Player)
tempModel$fit = predict(lmer(Lachnospirales ~  Impact_Load_ROUGH + (1|Player), data = subset(order_data, Player!="9" )))
png(filename = "Lach_Mixed_Model.png", width = 8, height = 5, units = "in", res =300)
ggplot(data = tempModel, aes(x = Impact_Load_ROUGH, y = Lachnospirales,col = Player, group = Player))+
  geom_line(aes(y=fit, group=Player), size=0.8) +
  geom_point(alpha = 0.8) + 
  theme_bw() + xlab("Impact Load") + ylab("% change in Lachnospirales")
dev.off()

lm_Lach = lmer(Lachnospirales ~  Orthopedic_Injury_1+Orthopedic_Injury_2+Prescription_Medications_1+ Prescription_Medications_2+ Prescription_Medications_3+ Caffeine_1 + Caffeine_2 + Caffeine_3 + Caffeine_4 + Cannabis_1 + Cannabis_2 + Cannabis_3 + Cannabis_4 + Self_Reported_Illness_1 + Self_Reported_Illness_2+ Self_Reported_Illness_3+Impact_Load_ROUGH + Blood_In_Stool + Bristol_Stool_Scale_1 +Bristol_Stool_Scale_2 + Bristol_Stool_Scale_3 +Bristol_Stool_Scale_4 +Bristol_Stool_Scale_6 +Bristol_Stool_Scale_7 + Suspected_Head_Impact_off_the_Field +Suspected_Head_Impact_on_the_Field + Nicotine_Products_1+Nicotine_Products_2+Nicotine_Products_3+Nicotine_Products_4 +  Creatine_1+Creatine_2 +Change_of_Living_or_Dining_Circumstance_1+Change_of_Living_or_Dining_Circumstance_3 + (1|Player), data = subset(order_data, Player!="9"))
sink("LM_Lach_R.txt")
print(summary(lm_Lach))
sink()

lm_Corio = lmer(Coriobacteriales ~  Orthopedic_Injury_1+Orthopedic_Injury_2+Prescription_Medications_1+ Prescription_Medications_2+ Prescription_Medications_3+ Caffeine_1 + Caffeine_2 + Caffeine_3 + Caffeine_4 + Cannabis_1 + Cannabis_2 + Cannabis_3 + Cannabis_4 + Self_Reported_Illness_1 + Self_Reported_Illness_2+ Self_Reported_Illness_3+Impact_Load_ROUGH + Blood_In_Stool + Bristol_Stool_Scale_1 +Bristol_Stool_Scale_2 + Bristol_Stool_Scale_3 +Bristol_Stool_Scale_4 +Bristol_Stool_Scale_6 +Bristol_Stool_Scale_7 + Suspected_Head_Impact_off_the_Field +Suspected_Head_Impact_on_the_Field + Nicotine_Products_1+Nicotine_Products_2+Nicotine_Products_3+Nicotine_Products_4 +  Creatine_1+Creatine_2 +Change_of_Living_or_Dining_Circumstance_1+Change_of_Living_or_Dining_Circumstance_3 + (1|Player), data = subset(order_data, Player!="9"))
sink("LM_Corio_R.txt")
print(summary(lm_Corio))
sink()

tempModel = order_data[, c("Coriobacteriales", "Impact_Load_ROUGH", "Player")]
tempModel = subset(tempModel, Player!="9" )
tempModel$Player = as.factor(tempModel$Player)
tempModel$fit = predict(lmer(Coriobacteriales ~  Impact_Load_ROUGH + (1|Player), data = subset(order_data, Player!="9" )))
png(filename = "Corio_Mixed_Model.png", width = 8, height = 5, units = "in", res =300)
ggplot(data = tempModel, aes(x = Impact_Load_ROUGH, y = Coriobacteriales,col = Player, group = Player))+
  geom_line(aes(y=fit, group=Player), size=0.8) +
  geom_point(alpha = 0.8) + 
  theme_bw() + xlab("Impact Load") + ylab("% change in Coriobacteriales")
dev.off()



lm_Enter = lmer(Enterobacterales ~  Orthopedic_Injury_1+Orthopedic_Injury_2+Prescription_Medications_1+ Prescription_Medications_2+ Prescription_Medications_3+ Caffeine_1 + Caffeine_2 + Caffeine_3 + Caffeine_4 + Cannabis_1 + Cannabis_2 + Cannabis_3 + Cannabis_4 + Self_Reported_Illness_1 + Self_Reported_Illness_2+ Self_Reported_Illness_3+Impact_Load_ROUGH + Blood_In_Stool + Bristol_Stool_Scale_1 +Bristol_Stool_Scale_2 + Bristol_Stool_Scale_3 +Bristol_Stool_Scale_4 +Bristol_Stool_Scale_6 +Bristol_Stool_Scale_7 + Suspected_Head_Impact_off_the_Field +Suspected_Head_Impact_on_the_Field + Nicotine_Products_1+Nicotine_Products_2+Nicotine_Products_3+Nicotine_Products_4 +  Creatine_1+Creatine_2 +Change_of_Living_or_Dining_Circumstance_1+Change_of_Living_or_Dining_Circumstance_3 + (1|Player), data = subset(order_data, Player!="9"))
summary(lm_Enter)

#lm_Micro = lmer(Micrococcales ~  Orthopedic_Injury_1+Orthopedic_Injury_2+Prescription_Medications_1+ Prescription_Medications_2+ Prescription_Medications_3+ Caffeine_1 + Caffeine_2 + Caffeine_3 + Caffeine_4 + Cannabis_1 + Cannabis_2 + Cannabis_3 + Cannabis_4 + Self_Reported_Illness_1 + Self_Reported_Illness_2+ Self_Reported_Illness_3+Impact_Load_ROUGH + Blood_In_Stool + Bristol_Stool_Scale_1 +Bristol_Stool_Scale_2 + Bristol_Stool_Scale_3 +Bristol_Stool_Scale_4 +Bristol_Stool_Scale_6 +Bristol_Stool_Scale_7 + Suspected_Head_Impact_off_the_Field +Suspected_Head_Impact_on_the_Field + Nicotine_Products_1+Nicotine_Products_2+Nicotine_Products_3+Nicotine_Products_4 +  Creatine_1+Creatine_2 +Change_of_Living_or_Dining_Circumstance_1+Change_of_Living_or_Dining_Circumstance_3 + (1|Player), data = subset(order_data, Player!="9"))
#summary(lm_Micro)
#bestglmer(lm_Bact, data = order_data)
...
```{r}
View(diversity_master_SWAY)
diversity_master_SWAY = diversity_master_SWAY %>% select(c(NEW.IMPACT.LOAD, 
                                                           Anxiety.Symptoms,
                                                           Depression.Symptoms,
                                                  ImpulseControl..ms., InspectionTime..ms.,
                                                  Reaction.time..ms.,Somatization.Symptoms,
...
indices_reaction = rep(which(!is.na(diversity_master_SWAY$Reaction.time..ms.)),3) + c(
  rep(-1,6), rep(0,6), rep(1,6))

View(diversity_master_SWAY[indices_reaction,])
```
